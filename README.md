...
рамках [bloc_example](https://github.com/fluttermiddlepodcast/bloc_example), небольшого проекта, где мы
...
выпуски подкаста, а так же [разбор `BlocBuilder`](https://youtu.be/98iF13KKdss).*

**Если опираться на код, то так неправильно:**
