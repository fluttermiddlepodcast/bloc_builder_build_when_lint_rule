...
- Поддержка и обновление: Dart, Flutter и сторонние плагины обновляются, и нужно следить за тем, насколько ваши правила
...
- Overengineering: есть риск создания бесполезных правил ради правил. Вкупе с минусами выше становится одной из главных
